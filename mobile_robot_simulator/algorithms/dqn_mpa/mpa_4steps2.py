...
if __name__ == '__main__':
    ...
    manage_memory()
    pack_file = 'C:\\Users\\61602\\Desktop\\Coding\\python\\mobile_robot_simulator\\algorithms\\dqn_mpa\\plots2\\'
    visualize = True
    ...
    agent = StackAgent(gamma=0.995,epsilon=0.9, lr = 1e-4,
                ...
                state_shape=6,mem_size=30000, local_mem_size = 10000, batch_size=64,
